...
const Banner = () => {
  return (
    <section id='home' className='max-w-containerSmall mx-auto py-10 mdl:py-24 flex flex-col gap-4 lgl:gap-8 mdl:px-10 xl:px-4'>
      <motion.h3 
      initial={{y: -10, opacity: 0}}
      animate={{y: 0, opacity: 1}}
      transition={{duration: 0.5, delay: 0.6}}
      className='text-textGreen text-lg font-titleFont tracking-wide'>HI, my name is</motion.h3>
      <motion.h1
      initial={{y: -10, opacity: 0}}
      animate={{y: 0, opacity: 1}}
      ...
      >I build things for the web.</span></motion.h1>
      <motion.p
       initial={{y: -10, opacity: 0}}
       animate={{y: 0, opacity: 1}}
